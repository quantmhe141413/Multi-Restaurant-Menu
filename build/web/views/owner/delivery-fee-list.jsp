    ...
    <div class="row">
        ...
        <main class="col-md-9 col-lg-10 main-content">
            ...
            <div class="page-header d-flex justify-content-between align-items-center">
                ...
                <div>
                    <a href="${pageContext.request.contextPath}/delivery-fee?action=add" class="btn btn-primary">
                ...
                <div class="card-body">
                    <form action="${pageContext.request.contextPath}/delivery-fee" method="GET">
                        ...
                        <div class="row g-3 align-items-center">
                            <div class="col-md-4">
                                <label class="form-label text-muted small mb-1"><i class="fas fa-tag"></i> Fee Type</label>
                                <select class="form-select" name="feeType">
                                    <option value="">All Fee Types</option>
                                    <option value="Flat" ${param.feeType == 'Flat' ? 'selected' : ''}>Flat - Fixed Amount</option>
                                    <option value="PercentageOfOrder" ${param.feeType == 'PercentageOfOrder' ? 'selected' : ''}>Percentage of Order</option>
                                    <option value="FreeAboveAmount" ${param.feeType == 'FreeAboveAmount' ? 'selected' : ''}>Free Above Amount</option>
                                </select>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label text-muted small mb-1"><i class="fas fa-map-marked-alt"></i> Coverage Zone</label>
                                                ...
                                                <td>
                                                    <c:choose>
                                                        <c:when test="${fee.feeType == 'Flat'}">
                                                            <span class="badge" style="background: linear-gradient(135deg, #3b82f6, #2563eb); color: white;">
                                                                <i class="fas fa-dollar-sign"></i> Flat
                                                            </span>
                                                        </c:when>
                                                        <c:when test="${fee.feeType == 'PercentageOfOrder'}">
                                                            <span class="badge" style="background: linear-gradient(135deg, #06b6d4, #0891b2); color: white;">
