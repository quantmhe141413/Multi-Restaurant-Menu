                                            ...
                                            <c:choose>
                                                ...
                                                <c:otherwise>
                                                    <c:forEach var="shift" items="${shifts}">
                                                        <c:set var="isPastShift"
                                                            value="${shift.shiftDate.before(currentDate)}" />
                                                        <tr class="${isPastShift ? 'table-secondary' : ''}">
                                                            <td><strong>#${shift.shiftId}</strong></td>
                                                            <td>
                                                                <i
                                                                    class="fas fa-calendar-day ${isPastShift ? 'text-muted' : 'text-info'}"></i>
                                                                <fmt:formatDate value="${shift.shiftDate}"
                                                                    pattern="MMM dd, yyyy" />
                                                            ...
                                                            <td>
                                                                <span class="badge"
                                                                    style="background: #6366f1;">${shift.position}</span>
                                                            </td>
                                                            <td>
                                                                <i class="fas fa-clock text-success"></i>
                                                                <fmt:formatDate value="${shift.startTime}"
                                                                    pattern="HH:mm" />
                                                            </td>
                                                            <td>
                                                                <i class="fas fa-clock text-danger"></i>
                                                                <fmt:formatDate value="${shift.endTime}"
                                                                    pattern="HH:mm" />
                                                            </td>
                                                            ...
                                                            <td>
                                                                <c:choose>
                                                                    <c:when
                                                                        test="${shift.attendanceStatus == 'Present'}">
                                                                    ...
                                                                    <c:when test="${shift.attendanceStatus == 'Late'}">
                                                                        <span class="badge bg-warning text-dark"><i
                                                                                class="fas fa-clock"></i> Late</span>
                                                                    </c:when>
                                                                    <c:when
                                                                        test="${shift.attendanceStatus == 'Absent'}">
                                                                        <span class="badge bg-danger"><i
                                                                                class="fas fa-times-circle"></i>
                                                                            Absent</span>
                                                                    </c:when>
                                                                    <c:when
                                                                        test="${shift.attendanceStatus == 'Excused'}">
                                                                    ...
                                                                    <c:otherwise>
                                                                        <span
                                                                            class="badge bg-light text-muted border">Not
                                                                            marked</span>
                                                                    </c:otherwise>
                                                                </c:choose>
                                                            </td>
                                                            ...
                                                            <td>
                                                                <div class="d-flex gap-1">
                                                                    ...
                                                                    <c:if
                                                                        test="${sessionScope.user.roleID == 2 || sessionScope.user.roleID == 1}">
                                                                    ...
                                                                    <!-- Edit & Delete (future shifts only) -->
                                                                    <c:choose>
                                                                        <c:when test="${isPastShift}">
                                                                            <button class="btn btn-sm btn-secondary"
                                                                                disabled
                                                                                title="Cannot edit past shifts">
                                                                                <i class="fas fa-lock"></i>
                                                                            </button>
                                                                        </c:when>
                                                                        <c:otherwise>
                                                                            <a href="${pageContext.request.contextPath}/shift-management?action=edit-assignment&id=${shift.shiftId}"
                                                                                class="btn btn-sm btn-warning"
                                                                                title="Edit Assignment">
                                                                                <i class="fas fa-edit"></i>
                                                                            </a>
                                                                            <a href="#"
                                                                                onclick="confirmDelete(${shift.shiftId})"
