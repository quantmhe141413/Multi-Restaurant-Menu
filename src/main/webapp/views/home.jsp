                ...
                * {
                ...
                .hero {
                    ...
                    background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)),
                        url('https://statics.vincom.com.vn/xu-huong/cac-mon-an-nha-hang-5-sao/nha-hang-5-sao-la-gi.jpg');
                    ...
                    <div style="display: flex; justify-content: center; gap: 0.5rem; margin-top: 2rem;">
                        <c:if test="${currentPage > 1}">
                            <a href="home?page=${currentPage - 1}&search=${currentSearch}&zone=${selectedZone}"
                                style="padding: 0.5rem 1rem; background: white; color: #2f3542; border: 1px solid #ddd; border-radius: 6px; text-decoration: none;">
                                Previous
                            </a>
                        </c:if>
                        ...
                        <c:forEach begin="1" end="${totalPages}" var="i">
                            <a href="home?page=${i}&search=${currentSearch}&zone=${selectedZone}"
                                style="padding: 0.5rem 1rem; background: ${i == currentPage ? '#ff4757' : 'white'}; color: ${i == currentPage ? 'white' : '#2f3542'}; border: 1px solid ${i == currentPage ? '#ff4757' : '#ddd'}; border-radius: 6px; text-decoration: none; font-weight: ${i == currentPage ? '600' : '400'};">
                                ${i}
                            </a>
                        </c:forEach>
