...
>>>>>>> Stashed changes
        ...
        <!-- Reviews Section -->
        <div class="container mb-5" id="reviews-section">
            <div class="reviews-section">
                ...
                <c:if test="${totalReviewPages > 1}">
                    <nav class="mt-4" aria-label="Phân trang đánh giá">
                        <ul class="pagination justify-content-center">
                            <li class="page-item ${currentReviewPage == 1 ? 'disabled' : ''}">
                                <a class="page-link" href="menu?restaurantId=${restaurant.restaurantId}&reviewPage=${currentReviewPage - 1}#reviews-section">
                                    <i class="fas fa-chevron-left"></i>
                                </a>
                            </li>
                            <c:forEach begin="1" end="${totalReviewPages}" var="p">
                                <li class="page-item ${p == currentReviewPage ? 'active' : ''}">
                                    <a class="page-link" href="menu?restaurantId=${restaurant.restaurantId}&reviewPage=${p}#reviews-section">${p}</a>
                                </li>
                            </c:forEach>
