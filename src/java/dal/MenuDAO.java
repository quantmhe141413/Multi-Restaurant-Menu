...
public class MenuDAO extends DBContext {
    ...
    public List<MenuItem> getMenuItemsByRestaurant(int restaurantId, String search, Integer categoryId,
            Boolean isAvailable, Double minPrice, Double maxPrice, String sortBy, String sortOrder, int page, int pageSize) {
    ...
    public int countMenuItemsByRestaurant(int restaurantId, String search, Integer categoryId,
