...
public class CoverageZoneController extends HttpServlet {
    ...
    private void handleList(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/view/owner/coverage-zone-list.jsp").forward(request, response);
    }
    ...
    private void showAddForm(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/view/owner/coverage-zone-add.jsp").forward(request, response);
    }
    ...
    private void showEditForm(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("/view/owner/coverage-zone-edit.jsp").forward(request, response);
        } catch (NumberFormatException e) {
            response.sendRedirect(request.getContextPath() + "/coverage-zone?action=list");
        }
    }
