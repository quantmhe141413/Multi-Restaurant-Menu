    ...
    <div class="row">
        ...
        <main class="col-md-9 col-lg-10 main-content">
            ...
            <div class="page-header">
                <h1><i class="fas fa-plus-circle text-primary"></i> Add Temporary Closure</h1>
            ...
            <div class="card shadow-sm">
                <div class="card-header" style="background: linear-gradient(135deg, #6366f1, #8b5cf6); color: white;">
                    <h5 class="mb-0"><i class="fas fa-door-closed"></i> Closure Period Configuration</h5>
                </div>
                <div class="card-body">
                    <form action="${pageContext.request.contextPath}/temporary-closure" method="POST" 
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <small class="text-muted">When the closure period begins (must be in the future)</small>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <small class="text-muted">When the closure period ends (must be after start date)</small>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="reason" rows="3" 
                                      placeholder="e.g., Staff training, Holiday, Maintenance..."></textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <small class="text-muted">If checked, this closure will be active immediately</small>
                        </div>
                        ...
                        <div class="text-center">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> Save Closure Period
                            </button>
                        </div>
                    </form>
                </div>
