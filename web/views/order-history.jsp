                                ...
                                <div class="order-item">
                                    ...
                                    <c:choose>
                                        <c:when test="${not empty menuItem.imageUrl}">
                                            <img src="${menuItem.imageUrl}" alt="${menuItem.itemName}" class="item-image"
                                                 onerror="this.src='${pageContext.request.contextPath}/images/food_default.png'">
                                        </c:when>
                                        <c:otherwise>
                                            <img src="${pageContext.request.contextPath}/images/food_default.png" alt="${menuItem.itemName}" class="item-image">
                                        </c:otherwise>
                                    </c:choose>
                                    ...
                                    <div class="item-price">
                                        <fmt:formatNumber value="${item.unitPrice * item.quantity}" pattern="#,###"/> VND
                                    </div>
                                </div>
                            </c:forEach>
                        </div>
